...
class ActorRolloutRefWorker(Worker):
    ...
    def __init__(self, config: DictConfig, role: str):
        ...
        if not torch.distributed.is_initialized():
            ...
            # After disabling IB, NCCL falls back to sockets but may auto-detect
            # a non-existent interface (e.g. eth0), causing "bind: No such device".
            # Explicitly pin to the default route interface.
    ...
    def _build_model_optimizer(  # noqa: C901
        ...
        try:
            ...
            AutoModelForVision2Seq = None  # e.g. transformers<4.46; use AutoModelForCausalLM only
