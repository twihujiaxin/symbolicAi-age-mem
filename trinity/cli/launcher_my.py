...
def explore(config: Config) -> None:
    """Run explorer."""
    # try:
    #     # using ray.init() to set runtime_env for the explorer process
    #     explorer = Explorer.get_actor(config)
    #     ray.get(explorer.prepare.remote())
...
def main() -> None:
    ...
    run_parser.add_argument("--config", type=str, default="/home/yuy/projects/Agent_RFT/Trinity-RFT/examples/grpo_gsm8k/gsm8k_2gpu.yaml", help="Path to the config file.")
